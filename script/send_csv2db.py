...
def import_csv_to_postgres(csv_file, user, password, host, port, database, table, schema, tag):
    ...
    dtype = {
        "column1": Integer,  # Replace "column1" with your actual column name
        "column2": String,   # Replace "column2" with your actual column name
        "timestamp": DateTime,
        "tag": String
    }
    ...
    try:
        ...
        df.to_sql(table, con=engine, schema=schema, if_exists='append', index=False, dtype=dtype)
...
def main():
    ...
    parser.add_argument("-p", "--password", type=str, default="superset",
                        help="PostgreSQL password (default: superset)")
    ...
    parser.add_argument("-d", "--database", type=str, default="superset",
                        help="PostgreSQL database name (default: superset)")
    parser.add_argument("-t", "--table", type=str, default="cloc_by_file_table",
