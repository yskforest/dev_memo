...
def main():
    ...
    parser.add_argument("-p", "--password", type=str, default="superset", help="PostgreSQL password (default: superset)")
    ...
    parser.add_argument("-d", "--database", type=str, default="superset", help="PostgreSQL database name (default: superset)")
    parser.add_argument("-t", "--table", type=str, default="cloc_by_file_table", help="Target table name for import (default: cloc_by_file_table)")
